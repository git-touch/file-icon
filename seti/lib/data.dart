...
const _coffee = 0xE013;
const _coffee_erb = 0xE014;
const _coldfusion = 0xE015;
const _config = 0xE016;
const _cpp = 0xE017;
const _crystal = 0xE018;
const _crystal_embedded = 0xE019;
const _css = 0xE01A;
const _csv = 0xE01B;
const _d = 0xE01C;
const _dart = 0xE01D;
const _db = 0xE01E;
const _default = 0xE01F;
const _deprecation_cop = 0xE020;
const _docker = 0xE021;
const _editorconfig = 0xE022;
const _ejs = 0xE023;
const _elixir = 0xE024;
const _elixir_script = 0xE025;
const _elm = 0xE026;
const _error = 0xE027;
const _eslint = 0xE028;
const _ethereum = 0xE029;
const _f_sharp = 0xE02A;
const _favicon = 0xE02B;
const _firebase = 0xE02C;
const _firefox = 0xE02D;
const _folder = 0xE02E;
const _font = 0xE02F;
const _git = 0xE030;
const _git_folder = 0xE031;
const _git_ignore = 0xE032;
const _github = 0xE033;
const _go = 0xE034;
const _go2 = 0xE035;
const _gradle = 0xE036;
const _grails = 0xE037;
const _graphql = 0xE038;
const _grunt = 0xE039;
const _gulp = 0xE03A;
const _hacklang = 0xE03B;
const _haml = 0xE03C;
const _happenings = 0xE03D;
const _haskell = 0xE03E;
const _haxe = 0xE03F;
const _heroku = 0xE040;
const _hex = 0xE041;
const _html = 0xE042;
const _html_erb = 0xE043;
const _ignored = 0xE044;
const _illustrator = 0xE045;
const _image = 0xE046;
const _info = 0xE047;
const _ionic = 0xE048;
const _jade = 0xE049;
const _java = 0xE04A;
const _javascript = 0xE04B;
const _jenkins = 0xE04C;
const _jinja = 0xE04D;
const _js_erb = 0xE04E;
const _json = 0xE04F;
const _julia = 0xE050;
const _karma = 0xE051;
const _kotlin = 0xE052;
const _less = 0xE053;
const _license = 0xE054;
const _liquid = 0xE055;
const _livescript = 0xE056;
const _lock = 0xE057;
const _lua = 0xE058;
const _makefile = 0xE059;
const _markdown = 0xE05A;
const _maven = 0xE05B;
const _mdo = 0xE05C;
const _mustache = 0xE05D;
const _new_file = 0xE05E;
const _npm = 0xE05F;
const _npm_ignored = 0xE060;
const _nunjucks = 0xE061;
const _ocaml = 0xE062;
const _odata = 0xE063;
const _pddl = 0xE064;
const _pdf = 0xE065;
const _perl = 0xE066;
const _photoshop = 0xE067;
const _php = 0xE068;
const _plan = 0xE069;
const _platformio = 0xE06A;
const _powershell = 0xE06B;
const _project = 0xE06C;
const _pug = 0xE06D;
const _puppet = 0xE06E;
const _python = 0xE06F;
const _rails = 0xE070;
const _react = 0xE071;
const _reasonml = 0xE072;
const _rollup = 0xE073;
const _ruby = 0xE074;
const _rust = 0xE075;
const _salesforce = 0xE076;
const _sass = 0xE077;
const _sbt = 0xE078;
const _scala = 0xE079;
const _search = 0xE07A;
const _settings = 0xE07B;
const _shell = 0xE07C;
const _slim = 0xE07D;
const _smarty = 0xE07E;
const _spring = 0xE07F;
const _stylelint = 0xE080;
const _stylus = 0xE081;
const _sublime = 0xE082;
const _svg = 0xE083;
const _swift = 0xE084;
const _terraform = 0xE085;
const _tex = 0xE086;
const _time_cop = 0xE087;
const _todo = 0xE088;
const _tsconfig = 0xE089;
const _twig = 0xE08A;
const _typescript = 0xE08B;
const _vala = 0xE08C;
const _video = 0xE08D;
const _vue = 0xE08E;
const _wasm = 0xE08F;
const _wat = 0xE090;
const _webpack = 0xE091;
const _wgt = 0xE092;
const _windows = 0xE093;
const _word = 0xE094;
const _xls = 0xE095;
const _xml = 0xE096;
const _yarn = 0xE097;
